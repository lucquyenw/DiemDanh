...
public class FileHelper {
    ...
    public static final String SVM_OFFLINE_PATH=DATA_PATH+"SVMO/";
    ...
    public File[] getSVMList(){
        return  getListOfFiles(SVM_PATH);
    }
    ...
    public File[] getTrainingList(String studentID){
        return getListOfFiles(TRAINING_PATH+studentID);
    }
    ...
    public Bitmap loadBitmapFromPath(String label) {
        File imgFile = new  File(TRAINING_PATH+label+"/"+label+"_0.png");
        if(imgFile.exists()) {
    ...
    public File createSvmTrainingFile(String classID){
        String path=SVM_PATH+"/"+classID+"/";
        createFolderIfNotExisting(SVM_PATH);
        createFolderIfNotExisting(path);
        String filepath = path + "svm_train";
    ...
    public File createOSvmTrainingFile(){
        createFolderIfNotExisting(SVM_OFFLINE_PATH);
        String filepath = SVM_OFFLINE_PATH + "svm_train";
        File trainingFile = new File(filepath);
        return trainingFile;
    }

    public File createOSvmPredictionFile(){
        String filepath = SVM_OFFLINE_PATH + "svm_predict";
        File predictionFile = new File(filepath);
        return predictionFile;
    }

    public File createSvmPredictionFile(String classID){
        String path=SVM_PATH+"/"+classID+"/";
        String filepath = path + "svm_predict";
        File trainingFile = new File(filepath);
        return trainingFile;
    }
    ...
    public File createOSvmTestFile(){
        String filepath = SVM_OFFLINE_PATH + "svm_test";
