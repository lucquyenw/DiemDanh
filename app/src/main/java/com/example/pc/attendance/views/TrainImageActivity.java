...
public class TrainImageActivity extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    private static final String API_Train_Image = "/user/PostImageForTrain";
    ...
    public void showDialog(String txt) {
        resultDialog = new Dialog(TrainImageActivity.this);
        resultDialog.setTitle("Train Image");
        resultDialog.setContentView(R.layout.dialog_regconition_train);
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(TrainImageActivity.this, "Permission denied to read your External storage", Toast.LENGTH_SHORT).show();
                }
                return;
            }
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if(images == null || images.size() == 0 || faces == null || faces.length == 0 || ! (images.size() == faces.length)){
            ...
            TrainAsysTask trainAsysTask=new TrainAsysTask(studentId);
    ...
    class TrainAsysTask extends AsyncTask<String,String,String> {
        ...
        public TrainAsysTask(String studentId){
