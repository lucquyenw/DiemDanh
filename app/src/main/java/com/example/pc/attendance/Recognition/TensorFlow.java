...
public class TensorFlow implements Recognition {
    ...
    public TensorFlow(Context context, int method,boolean offline){
        ...
        if(classificationMethod){
            rec = new SupportVectorMachine(context, method,offline);
        }
    }

    public TensorFlow(Context context,String classID, int method) {
        String dataPath = FileHelper.TENSORFLOW_PATH;
        PreferencesHelper preferencesHelper = new PreferencesHelper(context);
        inputSize = preferencesHelper.getTensorFlowInputSize();
        channels = preferencesHelper.getTensorFlowInputChannels();
        ...
        if(classificationMethod){
            rec = new SupportVectorMachine(context,classID, method);
        }
    }
